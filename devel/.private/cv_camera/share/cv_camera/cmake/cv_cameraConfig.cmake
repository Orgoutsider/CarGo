...
if("TRUE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/fu/apriltag_ws/src/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/fu/apriltag_ws/devel/.private/cv_camera)
  ...
  set(cv_camera_INSTALL_PREFIX /home/fu/apriltag_ws/install)
...
if(NOT "/home/fu/apriltag_ws/src/cv_camera/include;/usr/local/include/opencv4 " STREQUAL " ")
  set(cv_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/fu/apriltag_ws/src/cv_camera/include;/usr/local/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fu/apriltag_ws/src/cv_camera/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_camera_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_camera;/usr/local/lib/libopencv_calib3d.so.4.6.0;/usr/local/lib/libopencv_core.so.4.6.0;/usr/local/lib/libopencv_dnn.so.4.6.0;/usr/local/lib/libopencv_features2d.so.4.6.0;/usr/local/lib/libopencv_flann.so.4.6.0;/usr/local/lib/libopencv_highgui.so.4.6.0;/usr/local/lib/libopencv_imgcodecs.so.4.6.0;/usr/local/lib/libopencv_imgproc.so.4.6.0;/usr/local/lib/libopencv_ml.so.4.6.0;/usr/local/lib/libopencv_objdetect.so.4.6.0;/usr/local/lib/libopencv_photo.so.4.6.0;/usr/local/lib/libopencv_stitching.so.4.6.0;/usr/local/lib/libopencv_video.so.4.6.0;/usr/local/lib/libopencv_videoio.so.4.6.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fu/apriltag_ws/devel/.private/cv_camera/lib;/home/fu/apriltag_ws/devel/lib;/home/fu/demo05_ws/devel/lib;/home/fu/demo03_ws/devel/lib;/home/fu/demo02_ws/devel/lib;/home/fu/catkin_ws/devel/lib;/opt/ros/noetic/lib)
