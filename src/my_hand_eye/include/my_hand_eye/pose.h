...
#define ARM_JOINT5_POS_WHEN_CATCH 673
#define ARM_JOINT5_POS_WHEN_OPEN 877
...
namespace my_hand_eye
{
    ...
    public:
        ...
        bool put(int order, bool cat, double err_x, double err_y, bool pal);                  // 运动到椭圆放置处，可选择是否抓取
